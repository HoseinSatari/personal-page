...
return [
    ...
    */
    ...
    'password'             => 'کلمه عبور وارد شده ضعیف میباشد.',
    ...
    */
    ...
    'attributes' => [
        ...
        'terms'                 => 'شرایط',
        'province'              => 'استان',
        'name_re'               => 'نام و نام خانوادگی',
        'password_re'           => 'کلمه عبور',
        'phone_re'              => 'شماره موبایل',
        'cm'                    => 'کد ملی',
        'birth'                 => 'تاریخ تولد',
        'jobe'                  => 'شغل',
        'sex'                   => 'جنیست',
        'nameadd'               => 'گیرنده',
        'phoneadd'              => 'شماره همراه گیرنده',
        'newpass'               => 'کلمه عبور جدید',
        'oldpass'               => 'کلمه عبور  کنونی',
        'confirmpass'           => 'تکرار کلمه عبور',
        'code_meli'             => 'کد ملی',
        'confirmpassword'       => 'تکرار کلمه عبور',
        'avatar'                => 'تصویر پروفایل',
        'comision'              =>'کمیسیون',
        'rent_time'             =>'زمان دوره اجاره',
        'price'                 =>'مبلغ ',
        'amount'                =>'مبلغ ', 
        'percent'               =>' درصد  ', 
        'limite_time'             =>'  محدوده و نوع زمان  ', 
        'product'               =>'   محصول  ', 
        'discount_value_type'         =>'  نوع مبلغ تخفیف  ', 
