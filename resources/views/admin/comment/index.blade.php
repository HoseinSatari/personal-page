                    ...
                    @foreach($comments as $comment)
                        <tr>
                            ...
                            <td class="text-align-center">
                                        <a href="{{ \App\Models\Articles::find($comment->commentable_id)->slug]) ? route('single' , ['slug' =>  \App\Models\Articles::find($comment->commentable_id)->slug]) : ''}}">{{\App\Models\Articles::find($comment->commentable_id)->title}}</a>
                            </td>
                            <td class="text-align-center">
                                @if(!$comment->approved)
